...
export default function criarPessoas(){
    ...
    const salvarDadosPessoa = async (event) => {
        ...
        try{
            const response = await axios.post('http://localhost:3333/pessoa', data)
    ...
    return (
        ...
        <form onSubmit={salvarDadosPessoa} >
            <div className="mb-3">
